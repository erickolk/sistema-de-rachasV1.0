...
exports.UpdateSoccerFieldUseCase = void 0;
...
class UpdateSoccerFieldUseCase {
    static execute(id, data) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const soccerField = yield repository.update(id, data);
                if (!soccerField) {
                ...
                return (0, utils_1.left)(new http_error_1.HttpError(enums_1.HttpStatusCode.INTERNAL_SERVER_ERROR, 'Erro ao atualizar campo de futebol'));
            }
        });
    }
}
exports.UpdateSoccerFieldUseCase = UpdateSoccerFieldUseCase;
