...
exports.FetchSoccerFieldByUserUseCase = void 0;
...
class FetchSoccerFieldByUserUseCase {
    static execute(userId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const registredSoccerField = yield FetchSoccerFieldByUserUseCase.repository.allByUser(userId);
...
exports.FetchSoccerFieldByUserUseCase = FetchSoccerFieldByUserUseCase;
FetchSoccerFieldByUserUseCase.repository = new soccer_field_repository_1.SoccerFieldMongoRepository(soccer_field_model_1.default);
