...
exports.getSoccerFieldsByUserSchema = exports.createSoccerFieldSchema = exports.deleteSoccerFieldSchema = void 0;
exports.deleteSoccerFieldSchema = {
    params: {
        type: 'object',
        properties: {
...
exports.createSoccerFieldSchema = {
    body: {
        type: 'object',
        properties: {
...
exports.getSoccerFieldsByUserSchema = {
    response: {
        200: {
            type: 'array',
            items: {
